# Source Note — Behavior Gene Builder

- Slug: `behavior-gene-builder`
- ID: `BG-00`
...
Triggers: a recurring task family needs reusable behavior. Best-fit tasks: recurring reasoning patterns, domain-specific writing behavior, tone or risk-emphasis modules, research synthesis behaviors.

## Interactions and failure boundary

Companions: domain-core-builder, architect-orchestrator, resonance-gene-builder. Failure boundary: behavior-knowledge conflation; monolithic Gene; vague activation; undeclared conflicts; untested output contract.

## Unresolved details / interpretation boundary

The corpus recovers both a twelve-field schema and the strict historical separation between modular Genes and consolidated Cores.
