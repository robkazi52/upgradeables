# Source Note — Activation-Budget Funnel

- Slug: `activation-budget-funnel`
- ID: `T2-16`
...
Triggers: many sources or modules compete for attention. Best-fit tasks: multi-source research, long-document analysis, evidence-heavy authoring, policy or legal evidence review, large modular agent workflows.

## Interactions and failure boundary

Companions: scoped-loader, neuro-focus, stateblock. Failure boundary: Pause synthesis when evidence has not been captured with provenance or active pulls cannot be bounded without losing required coverage.; Fail verification when a synthesized claim cannot be traced back through the index..

## Unresolved details / interpretation boundary

The name, sequence, operating heuristic, rationale, and historical task mappings are explicitly recovered in all three source documents.
