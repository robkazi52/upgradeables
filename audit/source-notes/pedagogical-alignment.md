# Source Note — Pedagogical Alignment Constraint

- Slug: `pedagogical-alignment`
- ID: `T3-16`
...
Triggers: an audience or teaching level is known. Best-fit tasks: tutorials, documentation, stakeholder briefings, technical-to-nontechnical translation, onboarding.

## Interactions and failure boundary

Companions: explanation-minimality-scaffold, style-alignment. Failure boundary: oversimplification; undefined jargon; misleading analogy; missing prerequisite; correct but unusable abstraction.

## Unresolved details / interpretation boundary

The recovered catalog requires matching explanation complexity to the reader while preserving accuracy and using appropriate structure and examples.
