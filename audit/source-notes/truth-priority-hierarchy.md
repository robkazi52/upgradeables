# Source Note — Truth Priority Hierarchy

- Slug: `truth-priority-hierarchy`
- ID: `T3-06`
...
Triggers: evidence classes or authorities conflict. Best-fit tasks: multi-source research, policy and regulatory analysis, multi-validator workflows, domain decisions with mixed evidence classes.

## Interactions and failure boundary

Companions: multi-truth-gating, parallel-qms, epistemic-status-gating. Failure boundary: If a material conflict has no defensible domain/authority ordering, the resolver must not select a winner..

## Unresolved details / interpretation boundary

The key precedence principles are recovered; each implementation must still supply its domain-specific evidence hierarchy.
