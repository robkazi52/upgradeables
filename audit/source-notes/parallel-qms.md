# Source Note — Parallel Quality Management System
...
Triggers: a composed workflow needs structured quality evaluation. Best-fit tasks: high-stakes synthesis, complex repository validation, multiverse collapse, long-form factual work, safety-sensitive decisions.

## Interactions and failure boundary

Companions: multi-layer-consistency, cross-universe-consistency, fermionic-veto, critical-atomic-verification, bounded-exit. Failure boundary: Do not certify while a crucial truth is disputed, a safety/ethical veto is active, validator independence is falsely claimed, or bounded repair fails to converge..

## Unresolved details / interpretation boundary

All fifteen recovered modes remain semantically distinct; modern packaging into one parent profile is labeled normalized-from-recovered, and dQMS/mQMS overclaims are explicitly prohibited.
