# Source Note — Epistemic Status Gating

- Slug: `epistemic-status-gating`
- ID: `JAN26-05`
...
Triggers: claims of mixed certainty are present. Best-fit tasks: evidence synthesis, investigation, decision support, source-grounded research, high-stakes review.

## Interactions and failure boundary

Companions: grounding-no-invention, counterfactual-integrity, truth-priority-hierarchy. Failure boundary: If a decision-critical proposition has no defensible status or evidence pointer, it cannot support the conclusion..

## Unresolved details / interpretation boundary

The exact scaffold name is recovered; its procedure is normalized from the recovered Lf/Le/Lp/Lh and explicit T3 reasoning-state architecture.
