# Source Note — Resonance Gene Builder

- Slug: `resonance-gene-builder`
- ID: `A-06`
...
Triggers: the same module relationship recurs. Best-fit tasks: recurring validator-generator pairings, stable Core-Gene couplings, multi-module evidence workflows, repeated authority-sensitive compositions.

## Interactions and failure boundary

Companions: behavior-gene-builder, resonance, architect-orchestrator. Failure boundary: implicit coupling; repetition amplification; hidden-channel claims; authority inversion; nonterminating module feedback.

## Unresolved details / interpretation boundary

The purpose and recurrence trigger are directly recovered. The coupling manifest is normalized from recovered Resonance and Behavior Gene boundaries.
