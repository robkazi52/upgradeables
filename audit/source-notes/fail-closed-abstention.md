# Source Note — Fail-Closed Abstention

- Slug: `fail-closed-abstention`
- ID: `T3-11`
...
Triggers: required evidence cannot be verified. Best-fit tasks: medical, legal, or policy analysis, citation-bearing research, safety-critical decisions, source transcription and fidelity work.

## Interactions and failure boundary

Companions: grounding-no-invention, fermionic-veto, parallel-qms. Failure boundary: A conclusion cannot be committed while any indispensable evidence or integrity condition remains failed or unverifiable..

## Unresolved details / interpretation boundary

The stop-or-narrow behavior and supported-subset rule are directly recovered.
