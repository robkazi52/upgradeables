# Source Note — Adapter-First Experimentation

- Slug: `adapter-first-experimentation`
- ID: `T2-21`
...
Triggers: a new capability may destabilize a base workflow. Best-fit tasks: new loader or validator trials, tool integrations, alternative routing logic, model-specific optimization.

## Interactions and failure boundary

Companions: architect-orchestrator, future-proof-mode-selector. Failure boundary: base contamination; unmeasured promotion; hidden experimental state; interface sprawl; irreversible trial.

## Unresolved details / interpretation boundary

The recovered catalog explicitly specifies prototype as adapter, evaluate, then promote only after demonstrated value.
