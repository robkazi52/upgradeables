# Source Note — Reasoning Budget / Cognitive Governor

- Slug: `cognitive-governor`
- ID: `T3-17`
...
Triggers: effort allocation materially affects cost or quality. Best-fit tasks: mixed-risk queues, bounded research, iterative authoring, cost-sensitive agent workflows.

## Interactions and failure boundary

Companions: dynamic-depth-allocation, reasoning-throughput-governor, risk-tier-scaling. Failure boundary: over-polishing; premature exit; validation starvation; unbounded budget expansion; confusing global budget with local depth.

## Unresolved details / interpretation boundary

Recovered sources explicitly connect the governor to complexity, risk, expected value, over-polishing, endless recursion, and reasoning cost.
