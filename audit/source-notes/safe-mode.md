...
Triggers: execution is factual, consequential, or uncertain. Best-fit tasks: source-faithful extraction, production changes, high-risk recommendations, final publication, irreversible operations.

## Interactions and failure boundary

Companions: critical-atomic-verification, grounding-no-invention, hybrid-mode. Failure boundary: speculative execution; silent scope expansion; unverified state mutation; false completion; SAFE confused with minimal reasoning.

## Unresolved details / interpretation boundary

Strong grounding, narrow drift, atomic verification, and conservative output are directly recovered as SAFE's defining behaviors.
