...
Triggers: architecture or design benefits from broad exploration. Best-fit tasks: system architecture, novel workflow design, strategic planning, ambiguous research design.

## Interactions and failure boundary

Companions: multiverse-reasoning, parallel-qms, hybrid-mode. Failure boundary: unbounded ideation; architecture theater; unequal branch development; premature execution; branch assumption leakage.

## Unresolved details / interpretation boundary

The catalog explicitly recovers deeper planning, Multiverse, QMS, and Cosmic-level architecture work as POWER's purpose.
