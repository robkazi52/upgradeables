...
Full package and provenance: [`image-text-fidelity-capture`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/truth-grounding/image-text-fidelity-capture/UPGRADEABLE.md).
...
Full package and provenance: [`reflectos`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/validation/reflectos/UPGRADEABLE.md).
