...
Full package and provenance: [`power-mode`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/meta-control/power-mode/UPGRADEABLE.md).
...
Full package and provenance: [`hybrid-mode`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/meta-control/hybrid-mode/UPGRADEABLE.md).
...
Full package and provenance: [`reasoning-scale-controller`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/reasoning/reasoning-scale-controller/UPGRADEABLE.md).
...
Full package and provenance: [`behavior-gene-builder`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/meta-control/behavior-gene-builder/UPGRADEABLE.md).
...
Full package and provenance: [`domain-core-builder`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/meta-control/domain-core-builder/UPGRADEABLE.md).
...
Full package and provenance: [`meta-supervisor`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/meta-control/meta-supervisor/UPGRADEABLE.md).
...
Full package and provenance: [`adapter-first-experimentation`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/meta-control/adapter-first-experimentation/UPGRADEABLE.md).
...
Full package and provenance: [`future-proof-mode-selector`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/meta-control/future-proof-mode-selector/UPGRADEABLE.md).
