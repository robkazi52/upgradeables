# Legal Evidence — Runtime Pack

Purpose: Analyze jurisdiction- and date-sensitive legal sources while preserving authority and citation fidelity.

Task family: legal research and jurisdiction-sensitive source analysis

Activation boundary: Use for source-backed legal analysis tied to a declared jurisdiction and date where authority, quotation, and uncertainty must remain auditable; it is not legal advice.
