...
Full package and provenance: [`epistemic-status-gating`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/truth-grounding/epistemic-status-gating/UPGRADEABLE.md).
...
Full package and provenance: [`critical-atomic-verification`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/validation/critical-atomic-verification/UPGRADEABLE.md).
...
Full package and provenance: [`multi-truth-gating`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/truth-grounding/multi-truth-gating/UPGRADEABLE.md).
...
Full package and provenance: [`truth-redundancy`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/truth-grounding/truth-redundancy/UPGRADEABLE.md).
...
Full package and provenance: [`fail-closed-abstention`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/truth-grounding/fail-closed-abstention/UPGRADEABLE.md).
...
Full package and provenance: [`fermionic-veto`](https://github.com/robkazi52/upgradeables/blob/main/upgradeables/validation/fermionic-veto/UPGRADEABLE.md).
