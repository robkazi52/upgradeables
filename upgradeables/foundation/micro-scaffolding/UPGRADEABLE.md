...
Functional classes: planning-reasoning, state. Activation:
...
Activate `micro-scaffolding` only after task framing, combine it with the declared
...
Source ID: `T1-01` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
`consolidated-2026-09`. Aliases: Micro-Scaffolding (Planning Before Writing).
