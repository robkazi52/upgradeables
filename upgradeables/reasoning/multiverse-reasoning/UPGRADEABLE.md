...
Activate `multiverse-reasoning` only after task framing, combine it with the declared
...
Source ID: `A-01` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
