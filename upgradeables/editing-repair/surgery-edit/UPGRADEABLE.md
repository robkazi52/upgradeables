...
Functional classes: editing-repair, orchestration. Activation:
...
Activate `surgery-edit` only after task framing, combine it with the declared
...
Source ID: `A-08` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
