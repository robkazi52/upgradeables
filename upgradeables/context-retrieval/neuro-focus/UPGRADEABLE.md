...
Functional classes: context-retrieval, planning-reasoning. Activation:
...
Activate `neuro-focus` only after task framing, combine it with the declared
...
Source ID: `A-09` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
