...
Functional classes: orchestration, meta-control, planning-reasoning. Activation:
...
Activate `architect-orchestrator` only after task framing, combine it with the declared
...
Source ID: `O-01` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
