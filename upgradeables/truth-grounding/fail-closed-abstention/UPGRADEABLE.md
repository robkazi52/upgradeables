...
Functional classes: truth-grounding, validation, output. Activation:
...
Activate `fail-closed-abstention` only after task framing, combine it with the declared
...
Source ID: `T3-11` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
`consolidated-2026-09`. Aliases: Fail-Closed Tier-3 Abstention.
