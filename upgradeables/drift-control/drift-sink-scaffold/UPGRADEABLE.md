...
- discarded branches keep resurfacing
...
Activate `drift-sink-scaffold` only after task framing, combine it with the declared
...
Source ID: `JAN26-10` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
`training-scaffolding-2026-01-05`. Aliases: None.
Distinct exact-name snapshot entry; do not infer the unresolved ECL expansion. Exact name recovery; operational mechanism is a conservative modern interpretation.
