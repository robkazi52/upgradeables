...
Functional classes: drift-control, truth-grounding. Activation:
...
Activate `zero-drift-zones` only after task framing, combine it with the declared
...
Source ID: `T3-14` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
`consolidated-2026-09`. Aliases: Zero-Drift Citation / Quote / Definition Zones.
