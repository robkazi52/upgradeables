...
Activate `controlled-drift-corridors` only after task framing, combine it with the declared
...
Source ID: `T3-02` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
