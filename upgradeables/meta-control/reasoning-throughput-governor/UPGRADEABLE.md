...
Activate `reasoning-throughput-governor` only after task framing, combine it with the declared
...
Source ID: `T4-13` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
`consolidated-2026-09`. Aliases: RTG.
