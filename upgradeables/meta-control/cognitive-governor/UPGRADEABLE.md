...
Activate `cognitive-governor` only after task framing, combine it with the declared
...
Source ID: `T3-17` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
