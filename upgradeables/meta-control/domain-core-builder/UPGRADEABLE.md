...
Functional classes: meta-control, context-retrieval. Activation:
...
Activate `domain-core-builder` only after task framing, combine it with the declared
...
Source ID: `C-00` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
