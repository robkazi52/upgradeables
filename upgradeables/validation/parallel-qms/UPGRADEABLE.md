...
Activate `parallel-qms` only after task framing, combine it with the declared
...
Source ID: `PQ-00` in `OS_Upgradeable_to_Skills_Translation_Catalog_v2_Recovery_Merged.md`. Registry generation:
`consolidated-2026-09`. Aliases: Parallel-QMS.
