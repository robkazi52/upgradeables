...
| R | [Decision-First Scaffold (`decision-first-scaffold@1.0.0`)](../../upgradeables/reasoning/decision-first-scaffold/UPGRADEABLE.md) | analysis risks becoming directionless | — |
...
| A | [Risk-Tier Scaling (`risk-tier-scaling@1.0.0`)](../../upgradeables/meta-control/risk-tier-scaling/UPGRADEABLE.md) | task risk varies or must be classified | — |
...
| C | [Dynamic Depth Allocation (`dynamic-depth-allocation@1.0.0`)](../../upgradeables/meta-control/dynamic-depth-allocation/UPGRADEABLE.md) | task regions vary in difficulty or risk | — |
