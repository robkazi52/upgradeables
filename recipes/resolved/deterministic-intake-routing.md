...
| A | [Clarification Gateway (`clarification-gateway@1.0.0`)](../../upgradeables/foundation/clarification-gateway/UPGRADEABLE.md) | required variables are missing or instructions conflict | — |
...
| A | [Structured State Projection (`structured-state-projection@1.0.0`)](../../upgradeables/state/structured-state-projection/UPGRADEABLE.md) | a component needs a bounded state view | — |
| A | [Authority Anchor Enforcement (`authority-anchor-enforcement@1.0.0`)](../../upgradeables/orchestration/authority-anchor-enforcement/UPGRADEABLE.md) | multiple instruction authorities coexist | — |
...
| R | [Authenticity & Anti-Evasion Principle (`authenticity-anti-evasion@1.0.0`)](../../upgradeables/truth-grounding/authenticity-anti-evasion/UPGRADEABLE.md) | claims about evidence, actions, or completion are emitted | — |
