...
| R | [Zero-Drift Zones (`zero-drift-zones@1.1.0`)](../../upgradeables/drift-control/zero-drift-zones/UPGRADEABLE.md) | Activate when the task requires content contains fidelity-locked atoms. | — |
...
| A | [Work Reflection Loop OS / ReflectOS (`reflectos@1.1.0`)](../../upgradeables/validation/reflectos/UPGRADEABLE.md) | output needs a deliberate quality pass | — |
