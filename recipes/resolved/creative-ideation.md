...
[runtime recipe pack](../../runtime/recipes/creative-ideation.md) instead of full packages.
...
| R | [Bounded Change Rules (`controlled-drift-corridors@1.1.0`)](../../upgradeables/drift-control/controlled-drift-corridors/UPGRADEABLE.md) | synthesis or creativity must coexist with fidelity | — |
...
| A | [Domain / Mode Isolation (`domain-mode-isolation@1.1.0`)](../../upgradeables/state/domain-mode-isolation/UPGRADEABLE.md) | multiple domains or semantic modes coexist | — |
