...
| R | [Epistemic Status Gating (`epistemic-status-gating@1.0.0`)](../../upgradeables/truth-grounding/epistemic-status-gating/UPGRADEABLE.md) | claims of mixed certainty are present | — |
...
| R | [Multi-Truth Gating (`multi-truth-gating@1.0.0`)](../../upgradeables/truth-grounding/multi-truth-gating/UPGRADEABLE.md) | an important conclusion rests on fragile evidence | — |
...
| A | [Fermionic Veto Strengthening (`fermionic-veto@1.0.0`)](../../upgradeables/validation/fermionic-veto/UPGRADEABLE.md) | a defined critical condition must have veto authority | — |
