...
| A | [StateBlock (`stateblock@1.1.0`)](../../upgradeables/state/stateblock/UPGRADEABLE.md) | work spans multiple steps or components | — |
...
| A | [Dominant-Driver Isolation Scaffold (`dominant-driver-isolation-scaffold@1.1.0`)](../../upgradeables/reasoning/dominant-driver-isolation-scaffold/UPGRADEABLE.md) | Activate when the task requires many possible causes compete. | — |
...
| R | [Invariance Stress Scaffold (`invariance-stress-scaffold@1.1.0`)](../../upgradeables/validation/invariance-stress-scaffold/UPGRADEABLE.md) | a patch or rewrite must preserve invariants | — |
| R | [Micro-Repair (`micro-repair@1.1.0`)](../../upgradeables/editing-repair/micro-repair/UPGRADEABLE.md) | Activate when the task requires a defect is localized. | — |
...
| A | [Bounded ExIt (`bounded-exit@1.1.0`)](../../upgradeables/reasoning/bounded-exit/UPGRADEABLE.md) | a draft needs iterative improvement | — |
