...
| C | [StateBlock (`stateblock@1.0.0`)](../../upgradeables/state/stateblock/UPGRADEABLE.md) | work spans multiple steps or components | — |
...
| A | [Epistemic Status Gating (`epistemic-status-gating@1.0.0`)](../../upgradeables/truth-grounding/epistemic-status-gating/UPGRADEABLE.md) | claims of mixed certainty are present | — |
...
| C | [Fail-Closed Abstention (`fail-closed-abstention@1.0.0`)](../../upgradeables/truth-grounding/fail-closed-abstention/UPGRADEABLE.md) | required evidence cannot be verified | — |
