...
| R | [Mode Lock-In (`mode-lock-in@1.0.0`)](../../upgradeables/state/mode-lock-in/UPGRADEABLE.md) | a task can drift between modes | — |
...
| R | [Citation Fidelity Gate (`citation-fidelity@1.0.0`)](../../upgradeables/validation/citation-fidelity/UPGRADEABLE.md) | output contains citations or source-attributed claims | — |
| A | [Zero-Drift Zones (`zero-drift-zones@1.0.0`)](../../upgradeables/drift-control/zero-drift-zones/UPGRADEABLE.md) | content contains fidelity-locked atoms | — |
| A | [Controlled Drift Corridors (`controlled-drift-corridors@1.0.0`)](../../upgradeables/drift-control/controlled-drift-corridors/UPGRADEABLE.md) | synthesis or creativity must coexist with fidelity | — |
| A | [Counterfactual Integrity Gate (`counterfactual-integrity@1.0.0`)](../../upgradeables/truth-grounding/counterfactual-integrity/UPGRADEABLE.md) | counterfactual or hypothetical reasoning is used | — |
| A | [Micro-Repair (`micro-repair@1.0.0`)](../../upgradeables/editing-repair/micro-repair/UPGRADEABLE.md) | a defect is localized | — |
| A | [Placeholder Suppression (`placeholder-suppression@1.0.0`)](../../upgradeables/output/placeholder-suppression/UPGRADEABLE.md) | templates or staged artifacts are finalized | — |
