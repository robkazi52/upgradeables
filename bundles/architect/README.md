...
Use the metadata `load_order`. The orchestrator frames the design, Scoped Loader limits the active architecture, an optional suite supervisor governs only genuinely complex stacks, and a snapshot is taken before destructive editing.
